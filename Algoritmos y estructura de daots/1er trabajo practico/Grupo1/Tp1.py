...
def crear_locales():
        ...
        if cant_comida == cant_indumentaria and cant_comida < cant_perfumeria:
            ...
            print(f"el rubro con mas locales es Perfumeria con un total de {cant_perfumeria}")
            input()
            return True

        elif cant_comida == cant_perfumeria and cant_comida < cant_indumentaria:
            print(f"los rubros que tienen una menor cantidad de locales son perfumeria y comida con un total de {cant_comida} cada uno.")  
            print(f"el rubro con mas locales es Indumentaria con un total {cant_indumentaria}")
            input()
            return True
            ...
            print(f"el rubro con mas locales es Comida con un total de {cant_comida}")
            input()
            return True
            ...
            if cant_perfumeria > cant_comida:
              print(f"El rubro con menos locales es Comida con un total de {cant_comida} locales")
              input()
            else:
                print(f"El rubro con menos locales es perfumeria con un total de {cant_perfumeria} locales")
                input()
